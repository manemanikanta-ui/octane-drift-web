...
const CakeSlice = createLucideIcon("cake-slice", __iconNode$e);
const __iconNode$d = [
...
const Croissant = createLucideIcon("croissant", __iconNode$c);
const __iconNode$b = [
  [
    "path",
    {
...
const Sandwich = createLucideIcon("sandwich", __iconNode$5);
const __iconNode$4 = [
  [
    "path",
    {
